...
if [ "$OS" == "x86_64" ]; then
  ...
  wget http://ftp.pbone.net/mirror/apt.sw.be/redhat/el6/en/i386/rpmforge/RPMS/rpmforge-release-0.5.3-1.el6.rf.i686.rpm
...
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.github.com/choirulanam217/script/master/conf/badvpn-udpgw64"
fi
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.github.com/choirulanam217/script/master/conf/squid-centos.conf"
...
# pasang bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "https://raw.github.com/choirulanam217/script/master/conf/bmon64"
else
  wget -O /usr/bin/bmon "https://raw.github.com/choirulanam217/script/master/conf/bmon"
fi
